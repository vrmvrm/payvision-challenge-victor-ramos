...
describe('TransactionsService', () => {
  ...
  it('should return a transactions array', async () => {
    ...
    const newTransactions: TransactionResponseDto[] = await service.getTransactions(params);
  ...
  it('should return a transaction element', async () => {
    const params: TransactionQueryDto = {}; 
    const transactions: TransactionResponseDto[] = await service.getTransactions(params);
    const transaction: TransactionResponseDto = transactions.shift();
    const newTransaction: TransactionResponseDto = await service.getTransaction(transaction.id);
