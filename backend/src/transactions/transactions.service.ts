...
import { TransactionQueryDto, TransactionEntity, TransactionResponseDto } from './dto/transaction.dto';
...
export class TransactionsService {
    ...
    async getTransactions(params: TransactionQueryDto): Promise<TransactionResponseDto[]> {
        ...
        const transactionsFormatted: TransactionResponseDto[] = transactions.map(t => {
            return {
                ...t,
